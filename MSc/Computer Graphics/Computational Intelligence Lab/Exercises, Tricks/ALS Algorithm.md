...
[[Remember for Exam]]
$$
	v_j^* = (\Sigma_i \omega_{ij} u_i u_i^T + 2 \lambda I)^{-1} \cdot (\Sigma_i \omega_{ij} a_{ij} u_i)
$$
Same for V fixed:
$$
	u_i^* = (\Sigma_j \omega_{ij} v_i v_j^T + 2 \lambda I)^{-1} \cdot (\Sigma_j \omega_{ij} a_{ij} v_j)
$$
